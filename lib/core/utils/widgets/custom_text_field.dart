...
class CustomTextField extends StatelessWidget {
  const CustomTextField({super.key, required this.title, required this.radius, required this.textEditingController, required this.keyboardType});
  final String title;
  final double radius;
  ...
  OutlineInputBorder outLineInputBorder(double width ,double radius) {
    ...
    return OutlineInputBorder(
          borderRadius: BorderRadius.circular(radius),borderSide: BorderSide(color: Colors.black,width: width)
        );
  }
}
